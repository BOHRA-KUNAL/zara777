...
export const SideBar = ({ setActive }) => {
  ...
  let sidebarJson = [
    ...
    { link: "https://www.instagram.com/zara777.in?igsh=MTZ4bmc1M2F4bzc4bQ==", title: "Instagram", Icon: Instagram, color: '#EE2A7B' },
  ...
  return (
    <>
      <nav id="sidebar" className="active">
        ...
        {/* <div className="mx-4"> 
        <a href="https://backend.zara777.in/logo/Jodi_Play.apk" download>
<div class="link-input">
        <div class="download-link-bg">
