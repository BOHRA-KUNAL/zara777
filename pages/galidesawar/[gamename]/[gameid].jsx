  ...
  const renderCard = () => {
    return (
      <div ClassName="container-fluid">
        <div onClick={() => router.back()} style={{backgroundColor: 'rgb(61, 6, 87)', display: 'inline-block',fontWeight: '400',textAlign: 'center',whiteSpace: 'nowrap',verticalAlign: 'middle',marginTop: '10px'}} className="border p-2">
