    ...
    <div className="d-flex w-100  align-items-center justify-content-center">
      <div className="customCard mw700 p-3 w-100 m-3 mt-3 mb-4">
          <div onClick={router.back}>
            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#fff"><path d="M400-80 0-480l400-400 71 71-329 329 329 329-71 71Z"/></svg>
          </div>
        <div className="text-center">
          <img src={"/img/zara_header_image2.png"} style={{ maxWidth: "50%", objectFit: "contain" }} alt="logo" />
          <h3 className="mt-1 text-white">Welcome Back</h3>
          <div className="font-13 mb-3 text-white">Login to Continue</div>
        </div>
        <div>
          <Inputbox
          ...
          <button onClick={handleSubmit} className=" btn-theme mt-3">
            Login
          </button>
          <div
          ...
          <div className="my-3 text-center text-white"> Don't have an account?</div>
