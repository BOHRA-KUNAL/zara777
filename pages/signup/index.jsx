    ...
    try {
      ...
      if (checkMobileResponse.data.status === true) {
        ...
        if (signUpResponse.data.status === true) {
          const sendotp = await ApiClient.sendotp({mobile: signUpResponse.data.mobile, app_key: "@34@Y#456)D9)(JE4dsj36f$%#(zara777!in)8fe8345*&^ef8ef8"});
      ...
      <div className="d-flex w-100 h-100 align-items-center justify-content-center">
        <div className="customCard p-3 w-100 m-3 mw700 my-4">
          <div className="text-center">
            <h3 className="mt-3 text-white">Sign Up</h3>
            <div className="font-12 mb-3 text-white">Create Your Account</div>
          </div>
          <div>
            <Inputbox
            ...
            <button 
              ...
              className="btn btn-theme form-control mt-3 text-white"
            >
              Sign Up
            </button>
            <div className="my-3 text-center text-white">Already have an account?</div>
            <button
