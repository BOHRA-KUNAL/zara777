...
const Fund = () => {
  ...
  const handleAmountChange = (newAmount) => {
    setAmount(newAmount);
    if (newAmount < 100 || newAmount > 500000) {
      setError("Amount must be between 100 and 500000");
    } else {
      setError("");
    }
  };
  ...
  const handleSubmit = async (e) => {
    ...
    if (!amount || amount < 100 || amount > 500000) {
      setError("Please enter a valid amount between 100 and 500000");
      return;
    }
    ...
    try {
      ...
      form.method = 'POST';
      form.action = 'https://www.brightshine.in/payment/process_x.php';
  ...
  return (
    <div className="container">
      <div className="card tb-10">
        ...
        <span className="text-center bold">Minimum deposit 100₹</span>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={{display: 'flex', justifyContent: 'space-around', alignItems: 'center'}} className="row bidoptions-list tb-10 gap-3">
            {[100,300 ,500 , 1000, 1500, 2000, 5000, 10000, 20000].map((amt) => (
