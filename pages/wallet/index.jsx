  ...
  const renderBankIcon = () => {
    return (
      ...
      >
        ...
        <b className="text-white">{amount} Pts</b>
        <div className="text-white">Hold Amount: {holdAmount} Pts</div>

        <div className="boxshadow border border-2 w-100 my-4 text-white p-3 px-2 px-sm-3 rounded d-flex align-items-center justify-content-around" style={{backgroundColor: '#3d0657'}}>
  ...
  const renderTypes = () => {
    ...
    return (
      <div className="d-flex justify-content-around my-3 gap-3">
        <div 
        style={{backgroundColor: "#3d0657", color: "#fff"}}
